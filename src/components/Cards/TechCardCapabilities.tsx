    ...
    >
      ...
      >
        ...
        <div className="grid grid-cols-12 gap-3 items-center">
          {/* Visual 4-Quadrant Capability Grid Viewport */}
          <div className="col-span-5 relative aspect-square rounded-xs overflow-hidden border border-black/30 bg-[#121316] shadow-inner flex items-center justify-center">
            <svg viewBox="0 0 100 100" className="w-full h-full p-2.5">
              {/* 4 Quadrants: Brand, Digital, Content, Experience */}
